...
function Produit() {
    ...
    const handleClick=()=>{
      setBackground(background === "white" ? "orange" : "white")
    }
    ...
    const handlePanier=(product)=>{
        ...
        const produitExiste= card.find((item)=>item.id === product.id)
        if(produitExiste){
         ...
         localStorage.setItem( "card", JSON.stringify([...card,{...product,quantity:1}]))
        }
  ...
  <div className="container px-5 py-24 mx-auto" >
    <div className="lg:w-4/5 mx-auto flex flex-wrap " >
      ...
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-contain object-center  " style={{background}} 
      src={product.img}/>
      ...
      <div className="lg:w-1/3 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
          <div className="flex">
            ...
            <button className="border-2 border-gray-300 ml-1 bg-gray-700 rounded-full w-6 h-6 focus:outline-none"   onClick={handleClick}></button>
        ...
        <div className="flex">
          <span className="title-font font-medium text-2xl text-gray-900">{product.newPrice}fr</span>
            <div className=' flex mr-24 justify-between'>
            <Link to={'/Panier'} >
            <button  onClick={()=>handlePanier(product)} className="flex mx-2 text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded"> Card</button>
            </Link>
          <button className="flex ml-2 text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Acheter</button>
            </div>
          <button className="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-red-500 -ml-16">
            <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
...
(<h1 className=' text-center text-4xl mt-20'>Aucun produit a afficher</h1>)
